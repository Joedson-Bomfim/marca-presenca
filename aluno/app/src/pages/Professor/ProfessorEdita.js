...
const ProfessorEdita = ( {navigation} ) => {
    ...
    return(
        <ScrollView style={[styles.fundoTela, {backgroundColor: colors.background}]}>
            <Text style={[styles.tituloCadastro, {color: colors.text }]}>Editar Professor</Text>
            ...
            <TextInput label="Número Registro" mode="flat" value={credenciais.matricula} 
